...
TARGET = $(exedir)gbuild $(exedir)gbuildD $(exedir)gbuildD_VP $(exedir)gserver $(exedir)gserver_backup_scheduler $(exedir)gclient $(exedir)gquery $(exedir)gqueryD $(exedir)gqueryD_VP $(exedir)gconsole $(api_java) $(exedir)gadd $(exedir)gsub $(exedir)ghttp $(exedir)gmonitor $(exedir)gshow $(exedir)shutdown $(exedir)ginit $(exedir)gdrop $(testdir)update_test $(testdir)dataset_test
...
$(exedir)gbuildD: $(lib_antlr) $(objdir)gbuildD.o $(objfile) 
	$(MPICC) $(EXEFLAG) -o $(exedir)gbuildD $(objdir)gbuildD.o $(objfile) -L./api/http/cpp/lib -lclient $(library) $(openmp)

$(exedir)gbuildD_VP: $(lib_antlr) $(objdir)gbuildD_VP.o $(objfile) 
	$(MPICC) $(EXEFLAG) -o $(exedir)gbuildD_VP $(objdir)gbuildD_VP.o $(objfile) -L./api/http/cpp/lib -lclient $(library) $(openmp)

$(exedir)gquery: $(lib_antlr) $(objdir)gquery.o $(objfile) 
	$(CC) $(EXEFLAG) -o $(exedir)gquery $(objdir)gquery.o $(objfile) $(library) $(openmp)

$(exedir)gqueryD: $(lib_antlr) $(objdir)gqueryD.o $(objfile) $(api_cpp)
	$(MPICC) $(EXEFLAG) -o $(exedir)gqueryD $(objdir)gqueryD.o $(objfile) -L./api/http/cpp/lib -lclient $(library) $(openmp)

$(exedir)gqueryD_VP: $(lib_antlr) $(objdir)gqueryD_VP.o $(objfile) $(api_cpp)
	$(MPICC) $(EXEFLAG) -o $(exedir)gqueryD_VP $(objdir)gqueryD_VP.o $(objfile) -L./api/http/cpp/lib -lclient $(library) $(openmp)
...
$(objdir)gbuildD.o: Main/gbuildD.cpp Database/Database.h Util/Util.h $(lib_antlr)
	$(MPICC) $(CFLAGS) Main/gbuildD.cpp $(inc) -o $(objdir)gbuildD.o $(openmp)

$(objdir)gbuildD_VP.o: Main/gbuildD_VP.cpp Database/Database.h Util/Util.h $(lib_antlr)
	$(MPICC) $(CFLAGS) Main/gbuildD_VP.cpp $(inc) -o $(objdir)gbuildD_VP.o $(openmp)
...
$(objdir)gqueryD.o: Main/gqueryD.cpp Database/Database.h Util/Util.h $(lib_antlr)
	$(MPICC) $(CFLAGS) Main/gqueryD.cpp $(inc) -o $(objdir)gqueryD.o $(openmp) 

$(objdir)gqueryD_VP.o: Main/gqueryD_VP.cpp Database/Database.h Util/Util.h $(lib_antlr)
	$(MPICC) $(CFLAGS) Main/gqueryD_VP.cpp $(inc) -o $(objdir)gqueryD_VP.o $(openmp) 
